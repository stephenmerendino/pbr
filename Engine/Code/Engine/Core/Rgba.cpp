...
Rgba::Rgba(float* color_array_floats)
{
	SetAsFloats(color_array_floats[0], color_array_floats[1], color_array_floats[2], color_array_floats[3]);
}
...
Vector4 Rgba::GetAsVector4Normalized() const
{
	Vector4 normalized_values;
	GetAsFloats(&normalized_values.x);
