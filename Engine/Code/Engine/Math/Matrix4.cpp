...
void Matrix4::scale(float x_scale, float y_scale, float z_scale)
{
    scale_x(x_scale);
    scale_y(y_scale);
    scale_z(z_scale);
...
Matrix4 Matrix4::make_translation(float x, float y)
{
	return make_translation(x, y, 0.0f);
}

Matrix4 Matrix4::make_translation(const Vector2& translation)
{
	return make_translation(Vector3(translation, 0.0f));
}
...
Matrix4 Matrix4::make_scale(float x_scale, float y_scale, float z_scale)
{
    return make_scale(Vector3(x_scale, y_scale, z_scale));
}
