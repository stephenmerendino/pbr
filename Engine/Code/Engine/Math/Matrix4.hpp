...
public:
	...
	static Matrix4 make_translation(float x, float y);
	static Matrix4 make_translation(const Vector2& translation);
    ...
    static Matrix4 make_scale(float x_scale, float y_scale, float z_scale);
