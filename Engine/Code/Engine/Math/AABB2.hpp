...
public:
	...
	Vector2			get_uv(const Vector2& pos)										const;

	void			translate(const Vector2& translation);
	AABB2			get_translated(const Vector2& translation)						const;
	...
	friend AABB2	move_to_best_fit(const AABB2& obj, const AABB2& container);
	friend Vector2  get_smallest_offset(const AABB2& a, const AABB2& b);
