...
{
    return (unsigned int)s_live_alloc_size;
}

unsigned int mem_get_live_alloc_count()
{
    return (unsigned int)s_live_alloc_count;
}

unsigned int mem_get_highwater_alloc_byte_size()
{
    return (unsigned int)s_alloc_highwater_size;
}
...
{
    return (unsigned int)s_last_frame_alloc_size;
}
...
{
    // get total size
    size_t total_size = get_total_size_of_allocs(allocs, (unsigned int)num_allocs);
