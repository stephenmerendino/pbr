...
RasterState::RasterState(RHIDevice* owner, const std::string& cull_mode_string, const std::string& fill_mode_string, bool msaa_enabled)
	:m_device(owner)
	,m_dxRasterState(nullptr)
{
	...
	setup(cull_mode, fill_mode, msaa_enabled);
}

RasterState::RasterState(RHIDevice* owner, CullMode cullMode, FillMode fillMode, bool msaa_enabled)
	:m_device(owner)
	,m_dxRasterState(nullptr)
{
	setup(cullMode, fillMode, msaa_enabled);
}

void RasterState::setup(CullMode cullMode, FillMode fillMode, bool msaa_enabled)
{
