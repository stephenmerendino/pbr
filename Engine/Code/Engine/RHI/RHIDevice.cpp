...
RHIDevice::~RHIDevice()
{
	...
	// Only outputs in Debug/DebugInline builds
		...
		HRESULT hr = m_dxDevice->QueryInterface(__uuidof(ID3D11Debug), (void**)&dxDebug);
...
{
	return new StructuredBuffer(this, buffer, (unsigned int)object_size, (unsigned int)object_count);
}
