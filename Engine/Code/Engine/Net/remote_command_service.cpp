...
{
    m_session.register_message(RCS_SEND_COMMAND, this, &RemoteCommandService::on_command);
    m_session.register_message(RCS_SEND_ECHO, this, &RemoteCommandService::on_echo);
}
