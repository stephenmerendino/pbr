...
//
////---------------------------------------------------------------------------
//AudioChannelHandle AudioSystem::PlaySoundByID( SoundID soundID, float volumeLevel, PlaybackMode playbackMode )
//{
...
//
//		if(playbackMode == PLAYBACK_MODE_PLAY_TO_END){
